                    ...
                    <div class="card-body pt-3">
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                ...
                                <!-- Profile Edit Form -->
                                <form action="{{ route('profile.change-profile') }}" enctype="multipart/form-data"
                                    method= "post">
                                    @csrf
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            @if ($user->userDetail ?? '')
                                                <img src="{{ asset('storage/' . $user->userDetail->photo) }}"
                                                    alt="Profile" class="preview rounded-circle">
                                            @else
                                                <img src="{{ asset('assets/img/images.png') }}" alt="Profile"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <textarea name="about" class="form-control" id="about" style="height: 100px">{{ $user->userDetail->about ?? '' }}</textarea>
                                        </div>
                                    </div>
